...
def isolate_surfaces(surface, minD = 1.):
    '''
...
def contact_points_NewVersion(list_1, list_2, thresh):
    '''
    This function finds the groups of point of list1 and list2 that have a distance lesser that thresh 
    from at least one point of the other list.
    '''
...
def find_real_br(surface1, surface2, _threshold_):
    '''
    Obsolete function...
    '''
...
def fix_bridge_real_bs(patch_ab, patch_ag, Dpp):
    '''
...
class Surface:
    ...
    def enlarge_pixels(self, plane, THRES = 300):
    ...
    def build_patch(self, point_pos, Dmin):
        ...
        index_ = isolate_surfaces(patch_points, Dmin)
    ...
    def build_patch_no_IS(self, point_pos, Dmin):
    ...
    def create_plane(self, patch, z_c,Np = 20):
    ...
    def find_origin(self, rotated_pacth, CHECK = 0):
        '''
    ...
    def patch_reorient_old(self, patch_points):
        '''
        ...
        rot_p = eig_rotation(patch_points[:,:3], eigvec)
    ...
    def patch_reorient(self, patch_points, verso):
        ...
        phi, rot_pacth_all  = rotate_patch(res[:,:3], mean_v, verso,pin)
